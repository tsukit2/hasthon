...
tokcmp (TTLiteral (LTString     _ _))  (TTLiteral (LTString    _ _))      = True
tokcmp (TTLiteral (LTBytes      _ _))  (TTLiteral (LTBytes     _ _))      = True
tokcmp (TTLiteral (LTInteger    _ _))  (TTLiteral (LTInteger   _ _))      = True
...
pLTSTR         = tok (mktok $ TTLiteral $ LTString False "")   "String Literal"
pLTBYTES       = tok (mktok $ TTLiteral $ LTBytes False "")    "Byte Literal"
pLTINTEGER     = tok (mktok $ TTLiteral $ LTInteger Base10 "") "Integer Literal"
